...
dat1 <- summary_phylo_heatmap("../test_data/merged_table.tsv", LEVEL = NULL)
...
dat1 <- summary_phylo_heatmap("../test_data/merged_table.tsv")
...
expect_that(summary_phylo_heatmap("../test_data/merged_table.tsv", "man"), throws_error())


#
# when a merged table file that doesnt exist is given
expect_that(summary_phylo_heatmap("../test_data/merged_table.csv", "man"), throws_error())
